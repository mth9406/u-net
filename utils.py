...
class BrainTumorDataSet(Dataset):
    ...
    def __init__(self, data_dir = './data(jpeg)', transform= None, is_train= True):
        '''
        ...
        self.masks_path = glob(os.path.join(data_dir, 'masks/*.jpeg')) if is_train else None
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train:
            ...
            image = self._get_image(self.images_path[idx])
